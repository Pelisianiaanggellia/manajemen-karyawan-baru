            ...
            <div class="col-lg-11">
                ...
                <div class="card card-custom">
                    ...
                    <div class="card-body p-4">
                        <form action="{{ route('izin.store') }}" method="POST">
                            ...
                            <div class="row mb-4">
                                <h6 class="text-primary fw-bold mb-3"><i class="bi bi-person-badge me-2"></i>Data
                                    Pemohon</h6>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select id="jabatan" name="jabatan" class="form-control form-control-custom"
                                        required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select id="departmen" name="departmen" class="form-control form-control-custom"
                                        required>
                            ...
                            <div class="row mb-4">
                                <h6 class="text-primary fw-bold mb-3"><i class="bi bi-geo-alt me-2"></i>Rincian Tugas &
                                    Perjalanan</h6>
                            ...
                            <div class="row mb-4">
                                <h6 class="text-primary fw-bold mb-3"><i class="bi bi-cash-stack me-2"></i>Akomodasi &
                                    Biaya</h6>
                                <div class="col-md-6 mb-3">
                ...
                <div class="card card-custom">
                    <div class="header-card bg-light">
                        <h6 class="fw-bold mb-0 text-primary"><i class="bi bi-clock-history me-2"></i>Status Riwayat
                            Pengajuan Anda</h6>
                    </div>
